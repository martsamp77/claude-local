...
Steps:
1. Run `.\tools\windows\diagnostics\perf-snapshot.ps1 -SaveLog` using the PowerShell tool. (Windows-only for now; Linux/macOS variants planned.)
2. Read the output using the `windows-perf-diagnosis` skill.
